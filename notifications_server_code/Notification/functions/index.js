...
.onWrite((data, context) =>
{
	...
	const task_title = admin.database().ref(`/notifications/${receiver_user_id}/${notification_id}/taskTitle`).once('value');
						 	...
						 	return DeviceToken.then(result =>
						 	 {
						 	 	...
						 	 	const payload =
						 	 	{
						 	 		notification:
						 	 		{
						 	 			...
						 	 			body: `${senderUserName} Just Assigned You A Task (${from_task_title}).`,
						 	 			icon: "default"
						 	 		}
						 	 	};
